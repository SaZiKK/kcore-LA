...
parameter BASE_RAM_INIT_FILE = "C:\\Users\\ck_lo\\Downloads\\lab1.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
parameter EXT_RAM_INIT_FILE = "C:\\code\\Verilog_project\\NSCSCC2024\\out.bin";    //ExtRAM初始化文件，请修改为实际的绝对路径
